...
textures=(varargin{6});%纹理特征的类型

offSet = int8(varargin{3});     %纹理统计方向
noDirections = size(offSet,1);  %纹理统计方向的数量
...
% harMat的维度是:6x13 下面这个for循环将6x13的矩阵化成了1x78
...
%**************变量初始化/声明**********************
noDirections = size(offSet,1);  %方向的个数
